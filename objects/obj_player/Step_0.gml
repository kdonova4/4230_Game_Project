...
if (place_meeting(x,y, obj_slime)) or (place_meeting(x,y, obj_slime2)) or (place_meeting(x,y, obj_slime3)) or (place_meeting(x,y, obj_boss)) or (place_meeting(x,y, obj_flyingbat)) or (place_meeting(x,y, obj_flyingbat_Room1)){
	flashAlpha=1;
}
